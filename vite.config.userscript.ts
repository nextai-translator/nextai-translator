...
export default defineConfig({
    plugins: [
        ...
        monkey({
            ...
            userscript: {
                name,
                icon: 'https://cdn.jsdelivr.net/gh/lingualearn/lingualearn/public/icon.png',
                namespace: 'https://github.com/andersan/lingualearn',
                match: ['*://*/*'],
                author: 'https://github.com/lingualearn',
                license,
                description: {
